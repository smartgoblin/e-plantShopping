...
function ProductList() {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // State for the added plants to the cart
   ...
   const styleA={
    ...
    const handleAddToCart = (product) => {
        reduxDispatch(addCartItem(product)); // dispatch to CartSlice
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                    ...
                    <h1 className='cart'>
                        ...
                        <rect width="156" height="156" fill="none">7</rect>
                        ...
                        <text style={{ textAlign: 'right' }} x="70" y="140" fontFamily="Arial, sans-serif" fill="black">
                        {totalItems}
                        </text></svg>
                    </h1></a></div>
            </div>
